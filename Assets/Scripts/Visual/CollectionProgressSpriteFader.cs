...
namespace Visual
{
    ...
    public class CollectionProgressSpriteFader : MonoBehaviour
    {
        [Header("Range")]
        [SerializeField] private float transitionStartProgress;
        [SerializeField] private float transitionEndProgress = 1f;
        ...
        private void Update()
        {
            ...
            var t = Mathf.InverseLerp(transitionStartProgress, transitionEndProgress, GameManager.Instance.CollectionProgress);
